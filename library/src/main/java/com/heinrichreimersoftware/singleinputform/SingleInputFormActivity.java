...
public abstract class SingleInputFormActivity extends ActionBarActivity {
  ...
  private Property<ProgressBar, Integer> PB_PROGRESS_PROPERTY = new Property<ProgressBar, Integer>(
      Integer.class, "PB_PROGRESS_PROPERTY") {
  ...
  private void loadTheme() {
    ...
    mButtonFinishIcon = getResources().getDrawable(R.drawable.ic_action_accept);
		...
		/* Custom values */
    int[] attrs = {
        R.attr.colorPrimary, R.attr.colorPrimaryDark, android.R.attr.textColorPrimary,
    ...
    mDetailsSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
      ...
      public View makeView() {
        TextView view = (TextView) activity.getLayoutInflater()
            .inflate(R.layout.view_details, null);
  ...
  private void updateStep() {
    if (mStepIndex >= stepsSize()) {
      ...
      // finish(); Don't think is need to auto-finish
      return;
    }
    updateViews();
